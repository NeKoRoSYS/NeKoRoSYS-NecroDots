...
Based on mkhmtolzhas' rice. Meant for personal use only.

## Notes
- This repo assumes you already installed base-devel, git, flatpak, and yay.
...
- **IMPORTANT!** You can freely customize flatpak.txt and pkglist.txt
